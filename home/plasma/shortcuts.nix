{
  ...
  kwin = {
    "Activate Window Demanding Attention" = "Meta+Ctrl+Shift+Alt++A";
    "Cycle Overview" = [ ];
    ...
    "Switch to Screen to the Left" = "Meta+Y";
    "Switch to Screen to the Right" = "Meta+Shift+Y";
    "Toggle Night Color" = [ ];
    ...
    "karousel-column-width-decrease" = "Meta+Ctrl+H";
    "karousel-column-width-increase" = "Meta+Ctrl+L";
    "karousel-columns-squeeze-left" = "Meta+Ctrl+A";
    "karousel-columns-squeeze-right" = "Meta+Ctrl+D";
    "karousel-columns-width-equalize" = "Meta+B";
